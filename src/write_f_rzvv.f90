...
contains
    ...
    subroutine write_f ()
        ...
        integer :: nc_id, &
            ...
            R_binSize_id, &
            z_binSize_id, &
            vPerp_binSize_id, vPar_binSize_id, &
            vPerp_range_id, vPar_range_id, &
            density_id
        ...
        call dlg_check ( nf90_def_dim ( nc_id, "vPerp_nBins", vPerp_nBins, vPerp_nBins_id ) )
        ...
        call dlg_check ( nf90_def_dim ( nc_id, "vPerp_nBins_p1", vPerp_nBins+1, vPerp_nBins_p1_id ) )
        ...
        call dlg_check ( nf90_def_var ( nc_id, "f_rzvv", NF90_REAL, &
            (/ R_nBins_id, z_nBins_id, vPerp_nBins_id, vPar_nBins_id /), &
            f_rzvv_id ) )
        ...
        call dlg_check ( nf90_def_var ( nc_id, "vPerp_binCenters", NF90_REAL, &
            vPerp_nBins_id, vPerp_binCenters_id ) ) 
        ...
        call dlg_check ( nf90_def_var ( nc_id, "vPerp_binEdges", NF90_REAL, &
            vPerp_nBins_p1_id, vPerp_binEdges_id ) ) 
        ...
        call dlg_check ( nf90_def_var ( nc_id, "vPerp_binSize", NF90_REAL, &
            scalar_id, vPerp_binSize_id ) ) 
        ...
        call dlg_check ( nf90_def_var ( nc_id, "vPerp_range", NF90_REAL, &
            scalar_id, vPerp_range_id ) ) 
        ...
        call dlg_check ( nf90_put_var ( nc_id, vPerp_binCenters_id, vPerp_binCenters ) )
        ...
        call dlg_check ( nf90_put_var ( nc_id, vPerp_binEdges_id, vPerp_binEdges ) )
        ...
        call dlg_check ( nf90_put_var ( nc_id, vPerp_binSize_id, vPerp_binSize ) )
        call dlg_check ( nf90_put_var ( nc_id, vPar_binSize_id, vPar_binSize ) )
        call dlg_check ( nf90_put_var ( nc_id, vPar_range_id, vPar_range ) )
        call dlg_check ( nf90_put_var ( nc_id, vPerp_range_id, vPerp_range ) )
